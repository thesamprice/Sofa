...
function [dpsi,deps,epsa,rb,rp,rbp,rn,rbpn] =  Sofa_iauPn00b(varargin)
 ...
 [dpsi,deps,epsa,rb,rp,rbp,rn,rbpn] =  calllib('libsofa','iauPn00b',date1,date2,dpsi,deps,epsa,rb,rp,rbp,rn,rbpn)
