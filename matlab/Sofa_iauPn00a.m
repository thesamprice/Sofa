...
function [dpsi,deps,epsa,rb,rp,rbp,rn,rbpn] =  Sofa_iauPn00a(varargin)
 ...
 [dpsi,deps,epsa,rb,rp,rbp,rn,rbpn] =  calllib('libsofa','iauPn00a',date1,date2,dpsi,deps,epsa,rb,rp,rbp,rn,rbpn)
