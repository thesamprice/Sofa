...
function [dpsi,deps,epsa,rb,rp,rbp,rn,rbpn] =  Sofa_iauPn06a(varargin)
 ...
 [dpsi,deps,epsa,rb,rp,rbp,rn,rbpn] =  calllib('libsofa','iauPn06a',date1,date2,dpsi,deps,epsa,rb,rp,rbp,rn,rbpn)
